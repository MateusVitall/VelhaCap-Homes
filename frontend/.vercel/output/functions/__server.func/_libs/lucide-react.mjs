...
const Bath = createLucideIcon("bath", __iconNode$o);
const __iconNode$n = [
...
const BedDouble = createLucideIcon("bed-double", __iconNode$n);
const __iconNode$m = [
...
const ListPlus = createLucideIcon("list-plus", __iconNode$h);
