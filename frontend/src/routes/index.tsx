  ...
  head: () => ({
    meta: [
      { title: "CasaOeiras — Aluguel de imóveis em Oeiras-PI" },
      {
        name: "description",
        content:
          "A plataforma para alugar casas e apartamentos em Oeiras, Piauí. Anúncios verificados e contato direto com o proprietário.",
      },
      {
        property: "og:title",
    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img
            src={heroImg}
            alt="Casarão histórico em Oeiras-PI ao pôr do sol"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20 md:py-32 text-primary-foreground">
          ...
          <p className="mt-5 max-w-xl text-base md:text-lg text-primary-foreground/85 leading-relaxed">
            Conectamos famílias e proprietários em Oeiras. Anúncios verificados, contato direto, sem
            intermediários complicados.
          </p>
                ...
                property={{
                  ...
                  imagens:
                    p.imagens && p.imagens.length > 0
                      ? p.imagens
                      : ["https://placehold.co/800x600?text=Imovel"],
                }}
              />
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="font-display text-4xl md:text-5xl mt-2">
              Simples para quem aluga, fácil para quem anuncia
            </h2>
          </div>
